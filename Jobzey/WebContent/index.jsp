    ...
    <div class="bg-color">
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a href="index.html" class="navbar-brand">JOBZEY.com</a>
            </div>
      ...
      <div class="container text-center">
        <div class="wrapper wow fadeInUp delay-05s">
          <h2 class="top-title">Get Your Dream Job</h2>
          <h3 class="title">JOBZEY</h3>
          <h4 class="sub-title">Getting What You Deserve... </h4>
      ...
      <div class="row">
        <div class="col-md-3 wow fadeInLeft delay-05s">
          <div class="section-title">
            <h2 class="head-title">Jobs By Category</h2>
            <hr class="botm-line">
      ...
      <div class="row white">
        <div class="col-md-8 col-sm-12">
          <div class="section-title">
            ...
            <hr class="botm-line">
            <p class="sec-para black">Jobzey.com helps job seekers find the right job that matches their aspirations. Registering on Jobzey.com is free of cost.</p>
          </div>
        </div>
        <div class="col-md-12 col-sm-12">
          ...
          <div class="col-md-4 col-sm-6">
            ...
            <div class="location-info">
              <p class="white"><span aria-hidden="true" class="fa fa-map-marker"></span>Beml Layout, Bangalore, India</p>
              <p class="white"><span aria-hidden="true" class="fa fa-phone"></span>Phone: +91 7294164487</p>
              <p class="white"><span aria-hidden="true" class="fa fa-envelope"></span>Email: <a href="" class="link-dec">Shivangiasthana28@gmail.com</a></p>
            </div>
          </div>
          <div class="col-md-4">
