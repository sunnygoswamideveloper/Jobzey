...
<form action="UserServlet" method="post">
	...
	<p>
		<p  class="btn btn-block btn-twitter"> <i class="fab fa-twitter"></i>   Login via Twitter</p>
		<p  class="btn btn-block btn-facebook"> <i class="fab fa-facebook-f"></i>   Login via facebook</p>
	</p>
